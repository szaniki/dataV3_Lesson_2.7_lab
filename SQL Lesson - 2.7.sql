USE sakila; 
-- 1. How many films are there for each of the categories in the category table. - Answer: Sports with 74 films
...
-- 3. Which actor has appeared in the most films? - Answer: Gina Degeneres with 42 films
